 ...
 */
final class Version20250923203116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notifications (id SERIAL NOT NULL, user_id UUID NOT NULL, title VARCHAR(255) NOT NULL, message TEXT DEFAULT NULL, type VARCHAR(50) NOT NULL, is_read BOOLEAN NOT NULL, action_url VARCHAR(100) DEFAULT NULL, action_label VARCHAR(100) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, read_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, metadata JSON DEFAULT NULL, PRIMARY KEY(id))');
