 ...
 */
class getLeadsControllerService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/V1/LeadsController.php';

        $container->services['App\\Controller\\Api\\V1\\LeadsController'] = $instance = new \App\Controller\Api\V1\LeadsController(($container->privates['App\\Repository\\LeadRepository'] ?? $container->load('getLeadRepositoryService')), ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), ($container->privates['validator'] ?? self::getValidatorService($container)));
