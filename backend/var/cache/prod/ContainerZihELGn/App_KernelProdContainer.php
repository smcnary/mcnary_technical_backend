...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Api\\V1\\DocumentController' => 'getDocumentControllerService',
            ...
            'App\\Controller\\Api\\V1\\LeadStatusController' => 'getLeadStatusControllerService',
            'App\\Controller\\Api\\V1\\LeadgenController' => 'getLeadgenControllerService',
            ...
            'App\\Controller\\Api\\V1\\NotificationsController' => 'getNotificationsControllerService',
            'App\\Controller\\Api\\V1\\OpenPhoneController' => 'getOpenPhoneControllerService',
            'App\\Controller\\Api\\V1\\OpenPhoneWebhookController' => 'getOpenPhoneWebhookControllerService',
            ...
            'App\\Controller\\Api\\V1\\QrCodeEmailController' => 'getQrCodeEmailControllerService',
            ...
            'App\\Controller\\Api\\V1\\TwilioController' => 'getTwilioControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Api\\V1\\AgencyController', 'App\\Controller\\Api\\V1\\AuditFindingsController', 'App\\Controller\\Api\\V1\\AuditIntakeController', 'App\\Controller\\Api\\V1\\AuditsController', 'App\\Controller\\Api\\V1\\AuthController', 'App\\Controller\\Api\\V1\\BacklinksController', 'App\\Controller\\Api\\V1\\CampaignsController', 'App\\Controller\\Api\\V1\\CitationsController', 'App\\Controller\\Api\\V1\\ClientController', 'App\\Controller\\Api\\V1\\ContentBriefsController', 'App\\Controller\\Api\\V1\\ContentItemsController', 'App\\Controller\\Api\\V1\\DocumentController', 'App\\Controller\\Api\\V1\\FaqsController', 'App\\Controller\\Api\\V1\\GoogleBusinessProfileController', 'App\\Controller\\Api\\V1\\InvoicesController', 'App\\Controller\\Api\\V1\\KeywordsController', 'App\\Controller\\Api\\V1\\LeadStatusController', 'App\\Controller\\Api\\V1\\LeadgenController', 'App\\Controller\\Api\\V1\\LeadsController', 'App\\Controller\\Api\\V1\\MediaAssetsController', 'App\\Controller\\Api\\V1\\NotificationsController', 'App\\Controller\\Api\\V1\\OpenPhoneController', 'App\\Controller\\Api\\V1\\OpenPhoneWebhookController', 'App\\Controller\\Api\\V1\\PackagesController', 'App\\Controller\\Api\\V1\\PagesController', 'App\\Controller\\Api\\V1\\QrCodeEmailController', 'App\\Controller\\Api\\V1\\RankingsController', 'App\\Controller\\Api\\V1\\RecommendationsController', 'App\\Controller\\Api\\V1\\ReviewsController', 'App\\Controller\\Api\\V1\\SubscriptionsController', 'App\\Controller\\Api\\V1\\TwilioController', 'App\\Controller\\Api\\V1\\UploadsController', 'App\\Controller\\Api\\V1\\UserController', 'App\\Controller\\Api\\V1\\UserProfileController', 'App\\Controller\\Api\\V1\\WebhooksController', 'App\\Controller\\AuthController', 'App\\Controller\\MonitoringController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController', 'Endroid\\QrCodeBundle\\Controller\\GenerateController']);
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\DocumentSignatureRepository' => ['privates', 'App\\Repository\\DocumentSignatureRepository', 'getDocumentSignatureRepositoryService', true],
            'App\\Repository\\DocumentTemplateRepository' => ['privates', 'App\\Repository\\DocumentTemplateRepository', 'getDocumentTemplateRepositoryService', true],
            'App\\Repository\\DocumentVersionRepository' => ['privates', 'App\\Repository\\DocumentVersionRepository', 'getDocumentVersionRepositoryService', true],
            ...
            'App\\Repository\\LeadEventRepository' => ['privates', 'App\\Repository\\LeadEventRepository', 'getLeadEventRepositoryService', true],
            'App\\Repository\\LeadRepository' => ['privates', 'App\\Repository\\LeadRepository', 'getLeadRepositoryService', true],
            'App\\Repository\\LeadSourceRepository' => ['privates', 'App\\Repository\\LeadSourceRepository', 'getLeadSourceRepositoryService', true],
            ...
            'App\\Repository\\DocumentSignatureRepository' => '?',
            'App\\Repository\\DocumentTemplateRepository' => '?',
            'App\\Repository\\DocumentVersionRepository' => '?',
            ...
            'App\\Repository\\LeadSourceRepository' => '?',
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.public_api' => ($container->privates['.security.request_matcher.3mnsmji'] ?? $container->load('get_Security_RequestMatcher_3mnsmjiService'));
    ...
    protected static function getSerializerService($container)
    {
        ...
        $h = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, ['datetime_format' => 'Y-m-d\\TH:i:sP']);
        ...
        $u = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($m, $s, $f, $g, $t, NULL, ['datetime_format' => 'Y-m-d\\TH:i:sP'], $g);
        $v = new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL, ['datetime_format' => 'Y-m-d\\TH:i:sP']);

        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($f), new \App\Serializer\DateTimeImmutableNormalizer(), $i, $i, new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $j), new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer([], $j, $container->parameters['api_platform.serializer.default_context']), $i, new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $j), new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($a, $k, $b, $l, $q, $j, $container->parameters['api_platform.serializer.default_context'], true), new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($a, $c, $q), new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $j), $p, new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false, ['datetime_format' => 'Y-m-d\\TH:i:sP'], NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer(['datetime_format' => 'Y-m-d\\TH:i:sP']), $o, $r, new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(['datetime_format' => 'Y-m-d\\TH:i:sP']), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer(['datetime_format' => 'Y-m-d\\TH:i:sP'], $s), new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($m, $s, $g, $t, NULL, ['datetime_format' => 'Y-m-d\\TH:i:sP'])), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(['datetime_format' => 'Y-m-d\\TH:i:sP']), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\NumberNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, ['datetime_format' => 'Y-m-d\\TH:i:sP']), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($d, $l, $c, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $a, $f, 1, $container->parameters['api_platform.serializer.default_context']), $a, $l, $e, $container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($u, $c, $d), $u], [new \Symfony\Component\Serializer\Encoder\XmlEncoder(['datetime_format' => 'Y-m-d\\TH:i:sP']), $h, $v, new \Symfony\Component\Serializer\Encoder\CsvEncoder(['datetime_format' => 'Y-m-d\\TH:i:sP']), new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $v), new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')], ['datetime_format' => 'Y-m-d\\TH:i:sP']);
    }
    ...
    private $loadedDynamicParameters = [
        ...
        'openphone_base_url' => false,
        'openphone_webhook_secret' => false,
        'wappalyzer_api_key' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'openphone_api_key' => $container->getEnv('OPENPHONE_API_KEY'),
            'openphone_base_url' => $container->getEnv('OPENPHONE_BASE_URL'),
            'openphone_webhook_secret' => $container->getEnv('OPENPHONE_WEBHOOK_SECRET'),
            'wappalyzer_api_key' => $container->getEnv('WAPPALYZER_API_KEY'),
