...
class getMonolog_Handler_DeprecationService extends App_KernelProdContainer
{
    ...
    {
        $container->privates['monolog.handler.deprecation'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/prod.deprecation.log'), 'debug', true, NULL, false);
