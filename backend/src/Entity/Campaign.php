...
#[ApiResource(
    operations: [
        new Get(security: "is_granted('ROLE_SYSTEM_ADMIN') or is_granted('ROLE_AGENCY_ADMIN') or is_granted('ROLE_AGENCY_STAFF') or (is_granted('ROLE_CLIENT_ADMIN') and object.getClient().getClientId() == user.getClientId())"),
        new GetCollection(security: "is_granted('ROLE_SYSTEM_ADMIN') or is_granted('ROLE_AGENCY_ADMIN') or is_granted('ROLE_AGENCY_STAFF') or is_granted('ROLE_CLIENT_ADMIN') or is_granted('ROLE_CLIENT_STAFF')"),
        new Post(security: "is_granted('ROLE_SYSTEM_ADMIN') or is_granted('ROLE_AGENCY_ADMIN') or is_granted('ROLE_CLIENT_ADMIN')"),
        new Put(security: "is_granted('ROLE_SYSTEM_ADMIN') or is_granted('ROLE_AGENCY_ADMIN') or (is_granted('ROLE_CLIENT_ADMIN') and object.getClient().getClientId() == user.getClientId())"),
        new Delete(security: "is_granted('ROLE_SYSTEM_ADMIN') or is_granted('ROLE_AGENCY_ADMIN')")
    ],
