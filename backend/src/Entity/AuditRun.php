...
class AuditRun
{
    ...
    #[ORM\ManyToOne(targetEntity: Client::class, targetEntity: Client::class, inversedBy: 'auditRuns')]
    ...
    #[ORM\ManyToOne(targetEntity: User::class, targetEntity: User::class, inversedBy: 'initiatedAuditRuns')]
