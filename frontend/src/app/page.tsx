      ...
      <main className="flex-1">
        ...
        <section className="hero-gradient text-white py-20 lg:py-32 relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 left-0 w-full h-full bg-[url('data:image/svg+xml;base64,')] bg-repeat"></div>
          </div>
          
          <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight">
              Legal SEO That
              <span className="block text-blue-300">Actually Works</span>
            </h1>
            <p className="mt-8 text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed">
              Stop guessing. Start ranking. Get real-time visibility into your law firm&apos;s search performance with data-driven insights that drive more qualified leads.
            </p>
            ...
            <div className="mt-8 text-sm text-gray-300">
              <span className="font-semibold">Trusted by 500+ law firms</span> • No credit card required
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                From keyword tracking to competitor analysis, we provide the tools and insights to help your law firm climb the search rankings.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-blue-100 mb-10 max-w-3xl mx-auto">
              Join hundreds of law firms already using CounselRank.legal to dominate local search and attract more qualified clients.
            </p>
