          ...
          <div className="px-4 py-3 space-y-2">
            ...
            {user && (
              <div className="pt-2 border-t border-gray-200 space-y-2">
                ...
                <button 
                  className="flex items-center gap-3 px-3 py-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all duration-200 w-full text-left"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <User className="w-4 h-4" />
                  User Preferences
